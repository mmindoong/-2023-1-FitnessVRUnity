...
public class MediaPipeData
{
  ...
  public MediaPipeData(int maxBodiesCount = 20, int maxJointsSize = 100)
  {
...
public class TrackerHandler1 : MonoBehaviour
{
  ...
  public MediaPipeData m_lastFrameData = new MediaPipeData();
  ...
  void Awake()
    ...
    void Update()
    {
      ...
      {
        updateTracker(m_lastFrameData);
      }
  

    }

  public void updateTracker(MediaPipeData trackerFrameData)
    {
    ...
    private int findClosestTrackedBody(MediaPipeData trackerFrameData)
    {
        int closestBody = -1;
